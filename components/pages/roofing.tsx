                ...
                <div className="grid grid-cols-1 gap-8 items-start lg:grid-cols-2 lg:gap-12">
                            ...
                            >
                                <div className="bg-gradient-to-br from-purple-900 to-purple-800 p-6">
                                    ...
                                    <p className="mt-2 text-sm text-center text-purple-50">
                                        Connect with local roofing specialists today
                                    </p>
                                </div>
                    ...
                    <div className="space-y-8 order-1 lg:order-2">
                        <div className="space-y-6">
                            ...
                            >
                                Experience the security of a professionally installed roof with expert craftsmanship.
                                Elevate your home&#39;s protection, value, and curb appeal.
                            </motion.p>
                        </div>

                        {/* Hero Image */}
                        <motion.div className="relative group" initial={{ opacity: 0 }} transition={{ duration: 0.4 }} viewport={{ once: true }} whileInView={{ opacity: 1 }}>
                            <div className="overflow-hidden rounded-2xl border-2 border-blue-100 shadow-xl transition-all duration-150 group-hover:shadow-2xl">
                                <Image
                                    alt="Roofing service illustration"
                                    className="object-cover w-full h-auto transition-transform duration-150 group-hover:scale-105"
                                    height={600}
                                    src="/assets/roofing.webp"
                                    width={800}
                                />
                            </div>
                        </motion.div>
                        ...
                        <div className="grid grid-cols-3 gap-4 py-6 border-y border-gray-200">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-[#0062FF] sm:text-3xl">400+</div>
                                <div className="mt-1 text-xs text-gray-600 sm:text-sm">Roofs Installed</div>
                            </div>
                ...
                >
                    ...
                    >
                        <div className="p-8">
                            ...
                            <p className="text-center leading-relaxed text-gray-600">
                                Upgrade your roof with our high-quality, durable materials that offer both protection and aesthetic appeal
                            </p>
                        </div>
                    ...
                    >
                        <div className="p-8">
                            ...
                            <p className="text-center leading-relaxed text-gray-600">
                                Our certified professionals provide expert roofing services to protect your home with precision and care
                            </p>
                        </div>
                        <div className="h-1 w-full bg-gradient-to-r from-purple-900 to-purple-800 transform scale-x-0 transition-transform duration-150 group-hover:scale-x-100" />
                    </motion.div>
                    ...
                    >
                        <div className="p-8">
                            ...
                            <p className="text-center leading-relaxed text-gray-600">
                                Enjoy peace of mind with our comprehensive warranty coverage and dedicated support for your roofing project
                            </p>
                        </div>
                        <div className="h-1 w-full bg-gradient-to-r from-purple-900 to-purple-800 transform scale-x-0 transition-transform duration-150 group-hover:scale-x-100" />
                    </motion.div>
