...
export async function POST(request: NextRequest) {
    try {
        ...
        const requiredFields = [
            ...
            'homeOwnership', 'averageElectricBill', 'shade'
        ];
        ...
        const leadData = {
            ...
            propertyType: body.propertyType || 'Single Family Home', // Static default
            averageElectricBill: body.averageElectricBill,
            shade: body.shade,
        ...
        console.log('Client IP detected:', clientIP);
        // Resolve SRC from s1 mapping (solar vertical), fallback to env
        ...
        const mappedSrc = (runtimeSrcMap as any).solar?.[s1Value] || (runtimeSrcMap as any).global?.[s1Value] || process.env.LEAD_API_SRC;
        const leadApiData = {
            Request: {
                ...
                Average_Electric_Bill: leadData.averageElectricBill,
                Shade: leadData.shade,
